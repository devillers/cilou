...
export const metadata = getMetadataForPage({
  title: "Blog Reflexologie | Pause Reflexo",
  description: "Conseils et pratiques",
  keywords: [
    "Shiatsu assis",
    "reflexologie",
    "haute-savoie",
  ...
  return (
    <>
      <section className="relative">
        <div className="relative z-10 mx-auto flex flex-col  justify-center min-h-[640px] p-6 bg-[url(/images/404.webp)] bg-cover bg-center">
        ...
        <ul className="space-y-2  mb-6">
          ...
          <li>
            <h6 className="text-2xl md:text-4xl uppercase font-thin">
              nos conseils – les bonnes pratiques
            </h6>
          </li>
        </ul>

        <p className="text-center p-6 text-black text-md font-thin my-10 leading-8 italic">
          Inspirez, lisez, prenez soin de vous. À travers ce blog, découvrez des
          conseils pratiques, des témoignages et des éclairages sur la
          réflexologie et les approches naturelles du bien-être. Un espace dédié
          à celles et ceux qui veulent mieux comprendre leur corps, cultiver
          l’équilibre intérieur, et avancer sereinement vers un mieux-être
          durable.
        </p>
