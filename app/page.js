      ...
      <section className="relative">
        <div className="relative z-10 mx-auto justify-center flex flex-col min-h-[640px] bg-white bg-[url(/images/header.webp)] bg-cover bg-center">
          ...
          <ul className="uppercase font-bold max-w-[900px] p-6 z-20">
            <li className="text-6xl md:text-8xl  text-white/70">Praticienne   </li>
            <li className="text-6xl md:text-8xl  text-white">réflexologie </li>
            <li className="text-6xl md:text-7xl  text-white/70">Shiatsu assis</li>
            <li className="text-6xl md:text-8xl  text-white">au pays du</li>
            <li className="text-6xl md:text-6xl  text-white">Mont-Blanc</li> 
          </ul>
        </div>
      </section>
